...
class Reference:
    ...
    def _entered_by(self, enterer: "Reference", direction: int, tracker: MoveTracker, offset=0.5, enterer_already_should_flip=False, is_first_movement=False, last_enter_info=None):
        """
