...
class Reference:
    ...
    def _get_next_pos(self, direction     , tested                   , can_exit, offset=0.5):
        """
    ...
    class MoveRecord:
        def __init__(self, reference             , new_parent_room, new_pos                 ):
    ...
    def _pushed(self, direction     , tracker             ):
        """
    ...
    def pushed(self, direction     , undo_record                        , dry_run=False):
        """
        check if "this" object is pushable in the given direction
        """
    ...
    def _entered_by(self, enterer             , direction     , tracker             , offset=0.5):
        """
    ...
    def entered_by(self, enterer             , direction     , undo_record                        , offset=0.5, dry_run=False):
        """
        check if other objects can enter "this" object in the given direction
        (direction is where the "other object" want to go)
        """
    ...
    def eaten_by(self, eater             , direction     , undo_record                        , dry_run=False):
        """
        check if "this" objects can be eat by the "eater" object in the given direction
        (direction is where the "eater" object want to go)
        suppose the eater is going to go to the position of "this" object
