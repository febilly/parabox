...
class GraphicSplitter:
    ...
    def __init__(self, canvas     , block_width     , block_height     , amount     ,
                 default_color      = 0xffffffff, check_overflow       = True):
        # gatekeeper
    ...
    def get_virtual_graphic(self, index     )                  :
    ...
    @classmethod
    def copy_from(cls, other                   , canvas     ):
